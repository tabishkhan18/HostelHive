...
function RegisterStudent() {
  const registerStudent = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_BASE_URL}/api/student/register-student`, {
        method: "POST",
        headers: {
        ...
        <form method="post" onSubmit={registerStudent} className="flex flex-col gap-3">
          ...
          <div className="mx-12">
            ...
            <textarea
              ...
              className="border flex-grow sm:text-sm rounded-lg block w-full p-2.5 bg-neutral-700 border-neutral-600 placeholder-neutral-400 text-white focus:ring-blue-500 focus:border-blue-500 outline-none"
            />
          </div>

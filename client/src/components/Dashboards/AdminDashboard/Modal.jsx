    ...
    <div className="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[100%] max-h-full flex items-center justify-center bg-black bg-opacity-75">
      <div className="relative w-full max-w-2xl max-h-full lg:translate-x-[17%]">
        ...
        <div className="relative rounded-lg shadow bg-neutral-700">
          {/* Modal header */}
          <div className="flex items-start justify-between p-4 border-b rounded-t border-neutral-600">
            <h3 className="text-xl font-semibold text-white">
              {suggestion.title}
            </h3>
            <button
              type="button"
              className="text-neutral-400 bg-transparent rounded-lg text-sm p-1.5 ml-auto inline-flex items-center hover:bg-neutral-600 hover:text-white"
              onClick={() => closeModal()}
            >
              <svg
                className="w-5 h-5"
          ...
          {/* Modal footer */}
          <div className="flex items-center p-6 space-x-2 border-t rounded-b border-neutral-600">
            <button
